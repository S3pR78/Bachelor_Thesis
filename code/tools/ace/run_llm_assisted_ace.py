...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run LLM-assisted ACE pipeline from benchmark_raw.json to updated playbooks."
    )
    parser.add_argument("--run-dir", type=Path, required=True)
    parser.add_argument("--model", required=True)
    parser.add_argument("--mode", default="pgmr_lite")
    parser.add_argument("--playbook-dir", type=Path, default=Path("code/data/ace_playbooks"))
    ...
    # 2) LLM reflect + review + import per family
