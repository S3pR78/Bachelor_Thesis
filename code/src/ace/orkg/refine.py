...
def build_refine_prompt(
    *,
    ...
    return (
        ...
        f"{context}\n\n"
        "Refinement goals:\n"
        "- Merge duplicate or strongly overlapping rules.\n"
        "- Remove weak or generic rules that do not teach reusable ORKG structure.\n"
        "- Remove harmful, unsafe, or format-inconsistent rules.\n"
        "- Rewrite overly example-specific rules into reusable family-specific structural guidance.\n"
        ...
        "- Prefer fewer high-quality rules over many repetitive rules.\n"
        "- Do not copy full example queries.\n"
        "- Do not mention gold query, reference query, gold answer, expected answer, or hidden labels.\n\n"
        "Format constraints:\n"
        "- For PGMR-lite playbooks, final rules must use pgmr:/pgmrc: placeholder language and must not contain orkgp:/orkgc:/orkgr: identifiers.\n"
