"""CLI helpers for the online ACE workflow."""
...
def add_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--sparql-endpoint",
        required=True,
        help="SPARQL endpoint used by the evaluation step.",
    )
    parser.add_argument(
        "--initial-playbook",
        required=True,
    ...
    parser.add_argument(
        ...
        required=True,
        type=Path,
        help="Directory where online ACE outputs will be written.",
    )
    parser.add_argument(
        "--family",
        default=None,
    ...
    parser.add_argument(
        ...
        default=None,
        type=Path,
        help="Optional PGMR memory directory for PGMR restoration.",
    )
    parser.add_argument(
        "--iterations",
        default=3,
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Delete harmful rules from active context.",
    )
    parser.add_argument(
        "--min-harmful-count",
        default=2,
...
def execute_online_ace(args: argparse.Namespace) -> int:
    return run_online_ace_loop(build_config(args))
