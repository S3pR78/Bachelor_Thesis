...
def build_parser() -> argparse.ArgumentParser:
    ...
    query_parser.add_argument("--prompt-mode", required=False,choices=["empire_compass", "empire_compass_mini", "zero_shot", "few_shot"] ,help="Prompt mode to use for querying.")
    ...
    evaluate_parser.add_argument( "--prompt-mode",required=False,choices=["empire_compass", "empire_compass_mini", "zero_shot", "few_shot", "pgmr_lite_meta"],help="Prompt mode to use for evaluation.")
